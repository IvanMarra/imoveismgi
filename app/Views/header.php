...
?> <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="#" class="dropdown-item">
                        <div class="media">
                            <img src="<?= URL ?>/public/dist/img/ivan.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= URL ?>/usuarios/sair" role="button"><i class="fas fa-sign-out-alt"></i></a>
            </li>
        </ul>
    </nav>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item has-treeview menu-open">
                        <a href="#" class="nav-link active">
                            <!-- <i class="nav-icon fas fa-tacInícioter-alt"></i> -->
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?= URL ?>/paginas/home" class="nav-link">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?= URL ?>/gecob/pesquisarImovel" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Pesquisar</p>
                                </a>
                            </li>
